...
public class RepoController {
    ...
    @GetMapping(value="/repo/readme", params={"owner", "repo", "sha"})
    public String getRepoReadme(@RequestParam String owner, String repo, String sha) {
        System.out.println("Get repos readme");
        return repoService.getRepoReadme(owner, repo, sha);
    }
